...
REF_DIALOGUE_1 = Template("dialogue1", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_accuracy=0.76))
REF_DIALOGUE_2 = Template("dialogue2", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_accuracy=0.76))
REF_DIALOGUE_3 = Template("dialogue3", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_accuracy=0.76))
REF_DIALOGUE_4 = Template("dialogue4", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_accuracy=0.76))
REF_DIALOGUE_5 = Template("dialogue5", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_accuracy=0.76))
